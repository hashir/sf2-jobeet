...
use Como\TneBundle\Entity\Category;
use Como\TneBundle\Form\CategoryType;
...
class CategoryController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ComoTneBundle:Category')->findAll();

        return $this->render('ComoTneBundle:Category:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    ...
    public function showAction($slug, $page)
    {
      ...
      $total_jobs = $em->getRepository('ComoTneBundle:Job')->countActiveJobs($category->getId());
    ...
    public function editAction($id)
    {
        ...
        $entity = $em->getRepository('ComoTneBundle:Category')->find($id);
        ...
        return $this->render('ComoTneBundle:Category:edit.html.twig', array(
            'entity'      => $entity,
